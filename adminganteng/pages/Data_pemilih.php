...
<section class="content-header" id="headData">
  <h1>
    Data Pemilih
  </h1>
  <div id="box"></div>
...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      <button class="btn ripple tombol-blue tombol"  data-toggle="modal" data-target="#modal-tambah">
        <i class="fa fa-plus"></i> 
        Tambah Data
      </button>
      <button class="btn ripple tombol-red tombol" data-toggle="modal" data-target="#modal-hapus">
