...
<section class="content-header" id="headCalon">
  <h1>
    Calon
  </h1>
  <div id="box"></div>
  <ol class="breadcrumb" id="subBox">
    <li><a href="?p=dashboard" style="color: #1c58c7"><i class="fa fa-users"></i> Home</a></li>
    <li>Calon</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="box" id="contentCalon">
    <div class="box-header">
      <button id="btn-tambah" class="tombol tombol-blue ripple" style="outline: none" data-toggle="modal" data-target="#modal-form">
        <i class="fa fa-plus"></i> 
        Tambah Calon
      </button>
      <button id="hapusSemua" class="tombol tombol-red ripple" style="outline: none" data-toggle="modal" data-target="#modal-hapus">
  ...
  <div class="modal fade" id="modal-form">
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style="border-radius: 20px; padding: 3px; box-shadow: 1px 3px 10px rgba(000,000,000, .2);">
        ...
        <div class="modal-footer">
          <button type="button" class="ripple tombol tombol-blue" id="btn-simpan">Simpan</button>
          <button type="button" class="ripple tombol" id="btn-ubah">Ubah</button>
          <button type="button" class="ripple tombol" data-dismiss="modal">Tutup</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="modal-info">
    <div class="modal-dialog">
      <div class="modal-content" style="border-radius: 10px">
        ...
        <div class="modal-footer">
          <button type="button" class="btn tombol ripple" style="outline: none" data-dismiss="modal">Tutup</button>
        </div>
      </div>
    </div>
  </div>
